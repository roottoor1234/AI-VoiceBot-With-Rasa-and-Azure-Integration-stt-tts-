...
public class BotUI : MonoBehaviour
{
    ...
    public InputField   input;                  // InputField gameobject where user types their message
    ...
    /// <summary>
    /// This method creates chat bubles from prefabs and sets their positions.
    /// <summary>
    ...
    void Update()
    {
        ...
        // Na kleinei i efarmogh otan patame to back.
